 ...
 *
 * Official Companion SVG logo.
 * Used in widget headers and launcher.
 * Scales cleanly at any size (recommended 18x18).
 *
 * IMPORTANT: Do NOT modify this SVG.
 * Do NOT redraw, simplify, trace, recreate, approximate, or replace.
 * Do NOT modify geometry, proportions, curves, inner wave, stroke thickness, or colors.
 */

/** Official Companion SVG logo — do not modify. */
export const COMPANION_LOGO_SVG = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 505 494">
